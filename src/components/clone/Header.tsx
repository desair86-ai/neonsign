      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full h-[calc(100vh-80px)] bg-black overflow-y-auto flex flex-col shadow-2xl">
          <div className="flex flex-col">
            ...
            <Link onClick={() => setIsMobileMenuOpen(false)} href="/" className="text-[17px] font-semibold py-4 px-6 border-b border-white/10 hover:bg-white/5 transition-colors">Shark Tank</Link>
          </div>
          ...
          <div className="mt-4 mx-4 bg-[#1a1a1a] rounded-xl p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <a href="https://wa.me/919381001808" className="flex items-center gap-2 text-sm text-zinc-300 hover:text-white">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                <span className="underline underline-offset-4 decoration-white/30 hover:decoration-white">+91 93810 01808</span>
              </a>
            </div>

            <div className="flex flex-col gap-1">
              <span className="text-sm font-semibold">Contact for support</span>
              <a href="tel:+917013667750" className="flex items-center gap-2 text-sm text-zinc-300 hover:text-white">
                ...
                <span className="underline underline-offset-4 decoration-white/30 hover:decoration-white">+91 70136 67750</span>
              </a>
            </div>

            <div className="flex flex-col gap-1">
              <span className="text-sm font-semibold">Contact for sales</span>
              <a href="tel:+919381001808" className="flex items-center gap-2 text-sm text-zinc-300 hover:text-white">
            ...
            <div className="flex flex-col gap-1">
              ...
              <a href="mailto:info@neonattack.com" className="flex items-center gap-2 text-sm text-zinc-300 hover:text-white">
                ...
                <span className="underline underline-offset-4 decoration-white/30 hover:decoration-white">info@neonattack.com</span>
              </a>
            </div>
          </div>
